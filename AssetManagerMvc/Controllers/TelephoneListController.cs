    ...
    public class TelephoneListController : Controller
    {
        ...
        public class ITextEvents : PdfPageEventHelper
        {
            ...
            public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
            {
                ...
                iTextSharp.text.Font baseFontNormal = new iTextSharp.text.Font(iTextSharp.text.Font.HELVETICA, 9f, iTextSharp.text.Font.NORMAL);

                iTextSharp.text.Font baseFontBig = new iTextSharp.text.Font(iTextSharp.text.Font.HELVETICA, 9f, iTextSharp.text.Font.BOLD);
                ...
                PdfPCell pdfCell7 = new PdfPCell(new Phrase(PrintTime.ToShortDateString(), baseFontNormal));
