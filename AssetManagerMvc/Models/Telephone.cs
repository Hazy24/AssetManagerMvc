...
namespace AssetManagerMvc.Models
{
    public class Telephone : Asset
    {
        ...
        [RegularExpression(@"0[0-9]\s[0-9][0-9][0-9]\s[0-9][0-9]\s[0-9][0-9]|0[0-9][0-9][0-9]\s[0-9][0-9]\s[0-9][0-9]\s[0-9][0-9]", ErrorMessage = "Use e.g. 09 123 45 67 or 0485 12 34 56")]
